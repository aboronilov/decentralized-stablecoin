...
contract DSCEngine is ReentrancyGuard {
    ...
    error DSCEngine__HealthFactorBellowMinimum(uint256 healthFactor);
    ...
    /**
     * @notice follows CEI
     * @param amountDscToMint The DSC amount to mint
    ...
    /**
     * @notice return the indidcator how close the user is to liquidation
     * @param user sender
     */
    ...
    function _revertIfHealthFactorIsBroken(address user) internal view {
        ...
        if (userHealthFactor < MIN_HEALTH_FACTOR) {
            revert DSCEngine__HealthFactorBellowMinimum(userHealthFactor);
        }
    }
